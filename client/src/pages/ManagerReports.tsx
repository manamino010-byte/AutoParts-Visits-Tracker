                ...
                return (
                  <div key={v.id} className="visit-row">
                    ...
                    <div className="visit-det">
                      ...
                      {/* Badge حالة المأمورية */}
                      {v.visitType==="external_mission" && v.approvalStatus && (
                        <span className="vtag" style={
                          v.approvalStatus==="pending" ? {background:"rgba(245,158,11,0.12)",color:"#f59e0b"}
                          : v.approvalStatus==="approved" ? {background:"rgba(52,211,153,0.12)",color:"#34d399"}
                          : {background:"rgba(239,68,68,0.12)",color:"#ef4444"}
                        }>
                          {v.approvalStatus==="pending"?"⏳ قيد المراجعة":v.approvalStatus==="approved"?"✅ معتمدة":"❌ مرفوضة"}
                        </span>
                      )}
                    </div>
