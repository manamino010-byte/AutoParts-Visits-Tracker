                ...
                <div key={visit.id} className="history-item">
                  ...
                  <div className="item-details">
                    ...
                    <div>
                      ...
                      {/* ── Badge حالة المأمورية الخارجية ── */}
                      {visit.visitType === "external_mission" && visit.approvalStatus && (
                        <span
                          className="tag"
                          style={{
                            marginTop: 4,
                        ...
                        >
                          {visit.approvalStatus === "pending" ? "⏳ قيد المراجعة" : visit.approvalStatus === "approved" ? "✅ معتمدة" : "❌ مرفوضة"}
                        </span>
                      )}
